...
export interface IContingencyPoolContract
  extends Truffle.Contract<IContingencyPoolInstance> {
  "new"(meta?: Truffle.TransactionDetails): Promise<IContingencyPoolInstance>;
}
...
export interface IContingencyPoolInstance extends Truffle.ContractInstance {
