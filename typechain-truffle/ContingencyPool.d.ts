...
export interface ContingencyPoolContract
  extends Truffle.Contract<ContingencyPoolInstance> {
  "new"(
    _agentVault: string,
  ...
  ): Promise<ContingencyPoolInstance>;
}
...
export interface ContingencyPoolInstance extends Truffle.ContractInstance {
