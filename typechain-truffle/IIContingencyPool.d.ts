...
export interface IIContingencyPoolContract
  extends Truffle.Contract<IIContingencyPoolInstance> {
  "new"(meta?: Truffle.TransactionDetails): Promise<IIContingencyPoolInstance>;
}
...
type AllEvents = Entered | Exited | IncompleteSelfCloseExit;

export interface IIContingencyPoolInstance extends Truffle.ContractInstance {
