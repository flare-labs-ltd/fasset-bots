...
export interface SCProofVerifierMockContract
  extends Truffle.Contract<SCProofVerifierMockInstance> {
  "new"(
    meta?: Truffle.TransactionDetails
  ): Promise<SCProofVerifierMockInstance>;
}

type AllEvents = never;

export interface SCProofVerifierMockInstance extends Truffle.ContractInstance {
