...
import { TrackedStateRunConfig, createTrackedStateConfig } from "../config/BotConfig";
...
toplevelRun(async () => {
    const runConfig = JSON.parse(readFileSync(RUN_CONFIG_PATH).toString()) as TrackedStateRunConfig;
