...
import { HistoryItem, MonitoringStateEntity, TransactionEntity, UTXOEntity, WalletAddressEntity } from "@flarelabs/simple-wallet";
...
const options: Options<AbstractSqlDriver> = {
    entities: [WalletAddressEntity, AgentEntity, AgentMinting, AgentRedemption, Event, AgentUnderlyingPayment, AgentUpdateSetting,
        UTXOEntity, TransactionEntity, MonitoringStateEntity, HistoryItem, ActivityTimestampEntity, PricePublisherState],
