...
import { AgentEntity, AgentMinting, AgentRedemption, AgentUnderlyingPayment, AgentUpdateSetting, Event, ReturnFromCoreVault, TransferToCoreVault } from "../../src/entities/agent";
...
const testOptions: CreateOrmOptions = {
    entities: [WalletAddressEntity, AgentEntity, AgentMinting, AgentRedemption, Event, AgentUnderlyingPayment, AgentUpdateSetting,
        TransactionEntity, MonitoringStateEntity, HistoryItem, ActivityTimestampEntity, ReturnFromCoreVault, TransferToCoreVault],
    type: "sqlite",
