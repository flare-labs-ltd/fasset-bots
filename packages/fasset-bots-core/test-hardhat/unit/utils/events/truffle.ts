...
describe("Truffle unit tests", () => {
    const response = {
        ...
        receipt: {
            ...
            logs: [[Object]],
            logsBloom: "",
            type: "0x2",
            status: true,
