...
export interface IICoreVaultManagerContract
  extends Truffle.Contract<IICoreVaultManagerInstance> {
  "new"(meta?: Truffle.TransactionDetails): Promise<IICoreVaultManagerInstance>;
}
