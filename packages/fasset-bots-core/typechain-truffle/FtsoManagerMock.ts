...
export interface FtsoManagerMockContract
  extends Truffle.Contract<FtsoManagerMockInstance> {
  "new"(meta?: Truffle.TransactionDetails): Promise<FtsoManagerMockInstance>;
}
...
export interface FtsoManagerMockInstance extends Truffle.ContractInstance {
