...
export interface MockInterfaceContract
  extends Truffle.Contract<MockInterfaceInstance> {
  "new"(meta?: Truffle.TransactionDetails): Promise<MockInterfaceInstance>;
}

export type AllEvents = never;

export interface MockInterfaceInstance extends Truffle.ContractInstance {
  givenAnyReturn: {
  ...
  givenMethodRevert: {
    (method: string, txDetails?: Truffle.TransactionDetails): Promise<
      Truffle.TransactionResponse<AllEvents>
    >;
    call(method: string, txDetails?: Truffle.TransactionDetails): Promise<void>;
    sendTransaction(
      method: string,
      txDetails?: Truffle.TransactionDetails
    ): Promise<string>;
  ...
  invocationCountForMethod: {
    (method: string, txDetails?: Truffle.TransactionDetails): Promise<
      Truffle.TransactionResponse<AllEvents>
    >;
    call(method: string, txDetails?: Truffle.TransactionDetails): Promise<BN>;
    sendTransaction(
      method: string,
      txDetails?: Truffle.TransactionDetails
    ): Promise<string>;
