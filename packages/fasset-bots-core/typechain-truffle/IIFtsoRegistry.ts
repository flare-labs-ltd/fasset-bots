...
export interface IIFtsoRegistryContract
  extends Truffle.Contract<IIFtsoRegistryInstance> {
  "new"(meta?: Truffle.TransactionDetails): Promise<IIFtsoRegistryInstance>;
}

export type AllEvents = never;

export interface IIFtsoRegistryInstance extends Truffle.ContractInstance {
  addFtso: {
