...
export interface DiamondInitContract
  extends Truffle.Contract<DiamondInitInstance> {
  "new"(meta?: Truffle.TransactionDetails): Promise<DiamondInitInstance>;
}
...
export interface DiamondInitInstance extends Truffle.ContractInstance {
