...
export interface RelayMockContract extends Truffle.Contract<RelayMockInstance> {
  "new"(meta?: Truffle.TransactionDetails): Promise<RelayMockInstance>;
}
...
export interface RelayMockInstance extends Truffle.ContractInstance {
