...
export interface GovernedMockContract
  extends Truffle.Contract<GovernedMockInstance> {
  "new"(
    _governanceSettings: string,
    _initialGovernance: string,
    meta?: Truffle.TransactionDetails
  ): Promise<GovernedMockInstance>;
}
...
export interface GovernedMockInstance extends Truffle.ContractInstance {
