...
export interface GovernedFacetContract
  extends Truffle.Contract<GovernedFacetInstance> {
  "new"(meta?: Truffle.TransactionDetails): Promise<GovernedFacetInstance>;
}
...
export interface GovernedFacetInstance extends Truffle.ContractInstance {
