...
export const TEST_BTC_DEFAULT_FEE_PER_KB = toBNExp(0.001, BTC_DOGE_DEC_PLACES); // 100 sats/b
export const BTC_DEFAULT_FEE_PER_KB = toBNExp(0.00012, BTC_DOGE_DEC_PLACES); // 12 sats/b
...
export const BTC_MIN_ALLOWED_AMOUNT_TO_SEND = toBNExp(0.00008, BTC_DOGE_DEC_PLACES); // 8k sats
