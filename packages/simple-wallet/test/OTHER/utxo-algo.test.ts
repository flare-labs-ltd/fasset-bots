...
import { getMinAmountToSend } from "../../src/chain-clients/utxo/UTXOUtils";
...
describe("UTXO selection algorithm test", () => {
    ...
    it("When doing RBF only confirmed UTXOs can be used", async () => {
        ...
        const [, newUTXOs] = await wClient.transactionService.preparePaymentTransaction(0, fundedAddress, targetAddress, getMinAmountToSend(wClient.chainType), toBNExp(1, BTC_DOGE_DEC_PLACES - 4), undefined, originalTxEnt);
