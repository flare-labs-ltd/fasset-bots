...
import { BTC_DEFAULT_FEE_PER_KB, BTC_DUST_AMOUNT, BTC_MAX_ALLOWED_FEE, BTC_MIN_ALLOWED_AMOUNT_TO_SEND, BTC_MIN_ALLOWED_FEE, ChainType, DOGE_DEFAULT_FEE_PER_KB, DOGE_DUST_AMOUNT, DOGE_MIN_ALLOWED_AMOUNT_TO_SEND, UTXO_OUTPUT_SIZE, UTXO_OUTPUT_SIZE_SEGWIT } from "../../src/utils/constants";
