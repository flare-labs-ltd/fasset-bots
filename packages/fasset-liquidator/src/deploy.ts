...
import { abi as UniswapV2RouterMockAbi, bytecode as uniswapV2RouterMockBytecode } from '../artifacts/contracts/mock/UniswapV2/UniswapV2RouterMock.sol/UniswapV2RouterMock.json'
...
export async function deployUniswapV2Mock(wNat: AddressLike, signer: Signer): Promise<string> {
    return deployContract(UniswapV2RouterMockAbi, uniswapV2RouterMockBytecode, [wNat], signer)
}